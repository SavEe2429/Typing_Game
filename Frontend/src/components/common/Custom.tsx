import { Book,  Settings2 } from "lucide-react"; // แนะนำให้ลง lucide-react ครับ
    ...
    return (
        ...
        <div className="w-full max-w-2xl bg-[#252527] rounded-3xl p-6 sm:p-10 sm:px-16 flex flex-col items-center shadow-2xl border border-white/5 transition-transform hover:scale-[1.01]">
            ...
            <div className="flex items-center gap-3 sm:gap-4 mb-3">
                ...
                <div className="bg-blue-500 p-1.5 sm:p-2 rounded-xl shadow-lg shadow-blue-500/20 shrink-0">
                    <Settings2 className="size-5 sm:size-7 text-white fill-white" />
                </div>
            </div>
